...
class AdvLandingPages_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'adv-landing-pages'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'adv-landing-pages'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'adv-landing-pages'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'adv-landing-pages'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'adv-landing-pages');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'adv-landing-pages'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'adv-landing-pages');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'adv-landing-pages'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'adv-landing-pages') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'adv-landing-pages');
            case 'false':
                return __('false', 'adv-landing-pages');

            case 'Administrator':
                return __('Administrator', 'adv-landing-pages');
            case 'Editor':
                return __('Editor', 'adv-landing-pages');
            case 'Author':
                return __('Author', 'adv-landing-pages');
            case 'Contributor':
                return __('Contributor', 'adv-landing-pages');
            case 'Subscriber':
                return __('Subscriber', 'adv-landing-pages');
            case 'Anyone':
                return __('Anyone', 'adv-landing-pages');
        }
        return $optionValue;
    }
