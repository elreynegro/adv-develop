<div class="wrap">
	...
	<form action="options.php" method="post" id="<?php echo $plugin_id; ?>_options_form" name="<?php echo $plugin_id; ?>_options_form">
		...
		<table class="widefat">
			...
			<tr>
				<td>
					<label for="APP_BANNERS_appendToSelector">
						<p>Append to selector? - Append the banner to a specific selector</p>
                        <p><input type="text" style="width:272px;height:24px;" name="APP_BANNERS_appendToSelector" value="<?php if(empty($appendToSelector)){ echo 'body'; } else { echo $appendToSelector;} ?>" /></p>
					</label>
				</td>
			</tr>
			...
			<tr>
				<td>
					<label for="APP_BANNERS_pushSelector">
						<p>Push selector? - What element is going to push the site content down; this is where the banner append animation will start.</p>
						<p><input type="text" style="width:272px;height:24px;" name="APP_BANNERS_pushSelector" value="<?php if(empty($pushSelector)){ echo 'html'; } else { echo $pushSelector;} ?>" /></p>
					</label>
				</td>
			</tr>
