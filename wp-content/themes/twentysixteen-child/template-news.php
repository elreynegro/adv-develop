<?php
/*
 * Template Name: In The News Posts
 */
...
<div class="aez-secondary-header hero-margin" style="background-image: url(/wp-content/themes/twentysixteen-child/assets/news_banner.jpg);
">
	<div class="aez-blog-text" style="width: 90%;">
	<h1 style="font-size: 3em !important;">In The News</h1>
	</div>
</div>
