...
(function($) {
    ...
    function createNewPromoCodeInput(prevNum) {
        ...
        var $container = $('<div>', { class: 'aez-form-item--with-btn' });
        ...
        if ( $( "input[name*='promo_code']" ).size() < 3 ) {
    ...
    function createNewPromoCodeTotalInput(prevNum) {
        ...
        if ( $( "input[name*='promot_code']" ).size() < 3 ) {
    ...
    function handleAddCodeButtonClick(evt) {
        ...
        var currentNum = $( "input[name*='promo_code']" ).size();
    ...
    function handleRemoveCodeButtonTotalClick(evt) {
        ...
        if ($( "input[name*='promot_code']" ).size() > 2){
    ...
    function handleValidatePromoCode(event, abandonment = "no") {
        console.log('handleValidatePromoCode');
        disableReservePopup(); 
            ...
            $.ajax({
                ...
                .done(function(data) {
                    ...
                    if (data.Status == "ERROR") {
                                ...
                                var $errObject = {};
                                var $tmpObj = {};
                        $tmpObj['title'] = 'Error Using Promo Code.';
                        $tmpObj['text'] = data.ErrorMsg;
