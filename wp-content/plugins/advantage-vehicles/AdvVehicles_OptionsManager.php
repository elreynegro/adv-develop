...
class AdvVehicles_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'advantage-vehicles'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'advantage-vehicles'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'advantage-vehicles'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'advantage-vehicles'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'advantage-vehicles');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'advantage-vehicles'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'advantage-vehicles');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'advantage-vehicles'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'advantage-vehicles') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'advantage-vehicles');
            case 'false':
                return __('false', 'advantage-vehicles');

            case 'Administrator':
                return __('Administrator', 'advantage-vehicles');
            case 'Editor':
                return __('Editor', 'advantage-vehicles');
            case 'Author':
                return __('Author', 'advantage-vehicles');
            case 'Contributor':
                return __('Contributor', 'advantage-vehicles');
            case 'Subscriber':
                return __('Subscriber', 'advantage-vehicles');
            case 'Anyone':
                return __('Anyone', 'advantage-vehicles');
        }
        return $optionValue;
    }
