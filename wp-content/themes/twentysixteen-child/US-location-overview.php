<?php
/*
 * Template Name: US Location
 */
// wp_redirect('/locations/mco');
get_header();
$location_data = AdvLocations_Helper::getLocation();

wp_enqueue_script('locations_drop_down', '/wp-content/themes/twentysixteen-child/js/drop-down-location-page.js', array('jquery', 'select2'), '4.2.1', true);
...
<div class="location-page-fac aez-find-a-car-dropdown fac_dropdown  is-open">
...
if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
    <div class="aez-locations__us">
        ...
        <div class="aez-secondary-header hide_bg_mobiles" style="height: auto; background-image: url(<?php the_post_thumbnail_url(); ?>);">
...
<div class="location-usa-wrapper">
                ...
                <div class="location-usa-wrapper">
                    <div class="aez-info-block-container adv_location_info_block">
                        <div id="adv_location_info_block">
                            <div class="sub-details-loader">
                                <img alt="Loader" src="/wp-content/themes/twentysixteen-child/assets/ajax-loader-small-1.gif" /> Getting additional details.. Please wait..
        ...
        the_content();
                ...
                $location_duplicate= $location_data['LocationName']." (".$location_data['City'].", ".$location_data['State']." ".$location_data['CountryName'].") - ".$location_data['LocationCode'];
...
// error_log('get location_data: ' . print_r($location_data, true));
    ?>
    <div class="aez-body">
    ...
    <div class="aez-extra-header">
        <h4><i class="fa fa-info-circle" aria-hidden="true"></i> <span>Location Policies</span></h4>
    ...
    <div id="location-policy-drop-down" class="aez-extra-content">
        ...
        <input type="hidden" id="location_country" value="<?php echo  $location_data['Country'] ?>"/>
        <input type="hidden" id="location_phone" value="<?php echo  $phone_number ?>"/> 
        <input type="hidden" id="location_phone_display" value="<?php echo  $phone_number_display ?>"/> 
    </div>
...
// Latitude] => 39.836816\n    [Longitude] => -104.710624\
// error_log('$location_data: ' . print_r($location_data, true));
...
<script type='application/ld+json'> 
{
  ...
  "address": {
    ...
    "addressRegion": "<?php echo $location_data['StateName']; ?>",
