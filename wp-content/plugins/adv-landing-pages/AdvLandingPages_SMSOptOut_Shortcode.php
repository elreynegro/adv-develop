...
class AdvLandingPages_SMSOptOut_Shortcode extends AdvLandingPages_ShortCodeScriptLoader {
    ...
    */
	...
	public function handleShortcode($atts) {
        ...
        if (isset($member_number) && $member_number !== "") {
            $memberOptOut_response = AdvLandingPages_Helper::memberOptOut($member_number, 'SMS');
        } else {
