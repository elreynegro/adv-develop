...
class AdvContactUs_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'adv-contact-us'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'adv-contact-us'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'adv-contact-us'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'adv-contact-us'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'adv-contact-us');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'adv-contact-us'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'adv-contact-us');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'adv-contact-us'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'adv-contact-us') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'adv-contact-us');
            case 'false':
                return __('false', 'adv-contact-us');

            case 'Administrator':
                return __('Administrator', 'adv-contact-us');
            case 'Editor':
                return __('Editor', 'adv-contact-us');
            case 'Author':
                return __('Author', 'adv-contact-us');
            case 'Contributor':
                return __('Contributor', 'adv-contact-us');
            case 'Subscriber':
                return __('Subscriber', 'adv-contact-us');
            case 'Anyone':
                return __('Anyone', 'adv-contact-us');
        }
        return $optionValue;
    }
