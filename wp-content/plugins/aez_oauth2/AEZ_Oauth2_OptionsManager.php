...
class AEZ_Oauth2_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'aez_oauth2'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'aez_oauth2'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'aez_oauth2'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'aez_oauth2'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'aez_oauth2');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'aez_oauth2'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'aez_oauth2');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'aez_oauth2'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'aez_oauth2') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'aez_oauth2');
            case 'false':
                return __('false', 'aez_oauth2');

            case 'Administrator':
                return __('Administrator', 'aez_oauth2');
            case 'Editor':
                return __('Editor', 'aez_oauth2');
            case 'Author':
                return __('Author', 'aez_oauth2');
            case 'Contributor':
                return __('Contributor', 'aez_oauth2');
            case 'Subscriber':
                return __('Subscriber', 'aez_oauth2');
            case 'Anyone':
                return __('Anyone', 'aez_oauth2');
        }
        return $optionValue;
    }
