...
class AdvLocations_US_ListLocationsShortcode extends AdvLocations_ShortCodeScriptLoader {
    ...
    */
	...
	public function handleShortcode($atts) {
		...
		//Adding structure data markup localbusiness
		$this->location_list = '<script type="application/ld+json">
								{
...
">
	...
	<div class="aez-gradient">
		<h1>Car Rental USA - Locations</h1>
	</div>
</div>
...
<div class="aez-location-base-container">
	...
	<div id="america-title" class="aez-location-title">
		<h2>USA Car Rental Locations</h2>
		<p>Advantage Rent a Car provides car rentals in very convenient US airport locations for all of your American travel needs. Below, you can see where Advantage provides the best value in USA car rental!</p>
	</div>
...
foreach ($location_page_data_tmp as $value1) {
	...
	foreach ($locations_data_us as $value_array) {
		...
		$this->location_list .= '<a href="/us-location/' . $location_href . '" class="aez-icon-location">
