      ...
      function($parse,  $compile,  $http,  $templateCache, $interpolate, $q, sfErrorMessage,
        ...
        return {
          ...
          link: function(scope, element, attrs, sfSchema) {
            ...
            scope.buttonClick = function($event, form, e) {
              if (angular.isFunction(form.onClick)) {
                form.onClick($event, form, e);
              } else if (angular.isString(form.onClick)) {
                if (sfSchema) {
                  //evaluating in scope outside of sfSchemas isolated scope
                  sfSchema.evalInParentScope(form.onClick, {'$event': $event, form: form, e: e});
                } else {
                  scope.$eval(form.onClick, {'$event': $event, form: form, e: e});
                }
              }
            };
...
//             value = undefined;
//         } else {
//             if ( value != undefined && (typeof value.toISOString === 'function' )) {
