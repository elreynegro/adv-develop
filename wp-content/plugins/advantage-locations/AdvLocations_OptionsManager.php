...
class AdvLocations_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'advantage-locations'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'advantage-locations'); ?></h2>
            <table cellspacing="1" cellpadding="2"><tbody>
            <tr><td><?php _e('System', 'advantage-locations'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'advantage-locations'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'advantage-locations');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'advantage-locations'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'advantage-locations');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'advantage-locations'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'advantage-locations') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'advantage-locations');
            case 'false':
                return __('false', 'advantage-locations');

            case 'Administrator':
                return __('Administrator', 'advantage-locations');
            case 'Editor':
                return __('Editor', 'advantage-locations');
            case 'Author':
                return __('Author', 'advantage-locations');
            case 'Contributor':
                return __('Contributor', 'advantage-locations');
            case 'Subscriber':
                return __('Subscriber', 'advantage-locations');
            case 'Anyone':
                return __('Anyone', 'advantage-locations');
        }
        return $optionValue;
    }
