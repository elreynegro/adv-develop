...
class WPTiles extends Abstracts\WPSingleton
{
    ...
    public function get_tiles( $posts = array(), $opts = array() ) {
        ...
        <nav class="wp-tiles-pagination wp-tiles-pagination-ajax wp-load-more" id="<?php echo $wp_tiles_id; ?>-pagination">
    ...
    public function render_tile_html( $posts, $opts ) {
        ...
        foreach( $posts as $post ) :
			...
			$b_flag = ($tile_classes[1] == "blog")?1:0;
			$b_text_class = ($b_flag == 1)?"col-lg-9":"col-lg-12";
			$b_title_text_class = ($b_flag == 1)?"wp-blog-container-title-blog":"wp-blog-container-title-news";
				...
				<div class="blog-clearfix">
					<div class="row">
						...
						<div class="col-lg-3 mt-3">
							<img class="blog_img rounded" src="<?=$img?>" alt="Pineapple" width="170" height="170">
			
						</div>
						 <?php } ?>
						
						<div class="<?=$b_text_class?>">	 
							<div class="wp-blog-container-date mt-2"><?php echo $post_date; ?></div>
							<div class="<?=$b_title_text_class ?> mt-2"> <?php echo  $post->post_title; ?></div>
							<div  class="wp-blog-container-description mt-2"><?php echo substr($post_content,0,250); ?></div>
							<div><a class="wp-blog-container-button mt-2" href="<?php echo $this->_get_permalink( $post->ID ) ?>">more</a></div>
							
						</div>
						
					</div>
					<div class="wp-blog-container-line"></div>
				</div>		
